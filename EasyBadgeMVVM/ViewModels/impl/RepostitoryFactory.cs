...
namespace EasyBadgeMVVM.ViewModels
{
    public class RepostitoryFactory : IRepostitoryFactory
    {
        ...
        public FilterRepository GetFilterRepository(EasyBadgeModelContext model)
        {
            return new FilterRepository(model);
        }

        public RuleRepository GetRuleRepository(EasyBadgeModelContext model)
        {
            return new RuleRepository(model);
        }

        public TargetRepository GetTargetRepository(EasyBadgeModelContext model)
        {
